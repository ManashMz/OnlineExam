 ...
 <section>
 	<div class="row-fluid">
      <div class="span8 offset3">
         <h2 style="margin-bottom: 5px;">Rules:</h2>
         <p><strong>1. </strong>All field Must Be Filed Up.</p>
         <p><strong>2. </strong>Starting Time Format Must Be [YYYY-MM-DD hh:mm:ss] & Time Is 24 Hour Format,If These Condition Is Not True,Exam System Not Work For You.</p>
      </div>
    </div>
 </section>
